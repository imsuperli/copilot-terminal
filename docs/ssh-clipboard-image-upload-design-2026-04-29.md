...
1. `~/.cache/copilot-terminal/images`
2. `/tmp`
...
必要时可自动创建 `~/.cache/copilot-terminal/images`。
...
- [src/renderer/components/TerminalPane.tsx](/data/data/com.termux/files/home/develop/copilot-terminal/src/renderer/components/TerminalPane.tsx)
...
- [src/preload/index.ts](/data/data/com.termux/files/home/develop/copilot-terminal/src/preload/index.ts)
...
- [src/shared/types/electron-api.ts](/data/data/com.termux/files/home/develop/copilot-terminal/src/shared/types/electron-api.ts)
...
- [src/main/services/ProcessManager.ts](/data/data/com.termux/files/home/develop/copilot-terminal/src/main/services/ProcessManager.ts)
...
- [src/shared/types/workspace.ts](/data/data/com.termux/files/home/develop/copilot-terminal/src/shared/types/workspace.ts)
...
- [src/renderer/components/SettingsPanel.tsx](/data/data/com.termux/files/home/develop/copilot-terminal/src/renderer/components/SettingsPanel.tsx)
...
Ctrl+V / Cmd+V
  -> 检测到剪贴板是图片
  -> 上传到 ~/.cache/copilot-terminal/images 或 /tmp
  -> 成功后复制该远端路径
```
...
- `temporary-directory` 下优先使用 `~/.cache/copilot-terminal/images`
