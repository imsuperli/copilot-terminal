...
const IDE_CATALOG: IDECatalogEntry[] = [
  ...
  },
  {
    ...
    aliases: ['windsurf'],
    executableNames: {
      win32: ['Windsurf.exe', 'windsurf.cmd'],
      darwin: ['Windsurf.app'],
      linux: ['windsurf'],
    },
    displayNamePatterns: ['windsurf'],
    appNamePatterns: ['Windsurf.app'],
    bundleIdentifiers: ['com.codeium.windsurf'],
    windowsPathHints: ['Windsurf'],
    linuxPathHints: ['/usr/share/windsurf', '/opt/windsurf'],
  },
  {
    id: 'trae',
    name: 'Trae',
    ...
    aliases: ['trae'],
    executableNames: {
      win32: ['Trae.exe', 'trae.cmd'],
      darwin: ['Trae.app'],
      linux: ['trae'],
    },
    displayNamePatterns: ['trae'],
    appNamePatterns: ['Trae.app'],
    bundleIdentifiers: ['com.bytedance.trae'],
    windowsPathHints: ['Trae'],
    linuxPathHints: ['/opt/trae'],
  },
  {
    id: 'antigravity',
    name: 'Antigravity',
    ...
    aliases: ['antigravity'],
    executableNames: {
      win32: ['Antigravity.exe', 'antigravity.cmd'],
      darwin: ['Antigravity.app'],
      linux: ['antigravity'],
    },
    displayNamePatterns: ['antigravity'],
    appNamePatterns: ['Antigravity.app'],
    bundleIdentifiers: ['com.google.antigravity'],
    windowsPathHints: ['Google\\Antigravity', 'Antigravity'],
    linuxPathHints: ['/opt/antigravity'],
  },
];
...
const LAUNCH_ARGS_BY_ID: Record<string, (targetPath: string) => string[]> = {
  ...
  windsurf: DEFAULT_LAUNCH_ARGS,
  trae: DEFAULT_LAUNCH_ARGS,
  antigravity: DEFAULT_LAUNCH_ARGS,
};
