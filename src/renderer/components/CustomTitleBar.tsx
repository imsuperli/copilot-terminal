      ...
      >
        ...
        {title && (
          <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-1.5" style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties}>
            {onReturn && (
              <button type="button" tabIndex={-1} onMouseDown={preventMouseButtonFocus} onClick={onReturn} className="flex items-center justify-center w-6 h-6 rounded hover:bg-zinc-800 text-zinc-400 hover:text-zinc-100 transition-colors flex-shrink-0">
                <Home size={15} />
              </button>
            )}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center h-full" style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties}>
        <button type="button" tabIndex={-1} onMouseDown={preventMouseButtonFocus} onClick={handleMinimize} className="h-full px-4 hover:bg-zinc-800 transition-colors flex items-center justify-center" aria-label="Minimize">
          <Minus size={14} className="text-zinc-400" />
        </button>
        <button type="button" tabIndex={-1} onMouseDown={preventMouseButtonFocus} onClick={handleMaximize} className="h-full px-4 hover:bg-zinc-800 transition-colors flex items-center justify-center" aria-label="Maximize">
