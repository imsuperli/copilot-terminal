...
const APPEARANCE_SKIN_PRESETS: Array<{
  ...
  },
  {
    ...
    preview: 'radial-gradient(circle at 14% 16%, rgba(255, 255, 255, 0.94), transparent 24%), radial-gradient(circle at 82% 18%, rgba(83, 149, 255, 0.18), transparent 28%), linear-gradient(135deg, #f8fafc 0%, #eef3fb 52%, #ffffff 100%)',
    skin: {
      presetId: 'paper',
      kind: 'gradient',
